...
# letters.remove('a')
# print(letters)
# letters.remove('fadqwdqfqw') # ValueError
...
# list_of_lists = [[1, 2, 3], ['Katya', 'Mashsa', 'Sanya'], [4, 5, 6]]
...
# CTRL + C - остановка любых процнссов в треминале/
...
# guests_q = 4
# while guests_q > 0:
#     name_of_guest = input('Введи имя ')
#     if name_of_guest in list_of_names:
#         print('Вход закрыт!')
#         break
#     guests_q -= 1
# else:
