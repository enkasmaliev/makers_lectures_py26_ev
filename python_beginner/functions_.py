...
# функция - именованный блок кода, который принимает какие-либо значения, совершает над ними определенные действия и возвращает результат этих действий
...
# аргументы - значения для функции при вызове. Аргументов может быть столько, сколько у функции параметров
...
# add_nums(19, 20, 30)
# add_nums(num2=20, num3=80, num1=5)
# add_nums(num2=10, 30, 20) # Error
# add_nums(10, 20, num3=60) # Ok


# print()

""" args, kwargs - arguments, keywoard arguments """
...
#         print(f'{value} принадлежит {key}')

# get_names(Tanya=9495292949, Kolya=2848694516861)