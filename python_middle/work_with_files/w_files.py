...
# .read(n) - читает весь вайл или n символов, если n указан
...
# контекстный менеджер - рабочик поток, который отлавливает исключение
...
#     print(image.read())
#     with open('apple_copy.jpeg', 'wb') as image_copy:
#         image.seek(0)
