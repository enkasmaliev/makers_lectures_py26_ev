...
# Global - глобальное простраство имен
...
# Имена из локальной области не доступны в глобальной, а глобальные доступны внутри локальной области
