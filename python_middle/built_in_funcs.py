...
# map(func, iterable) - применяет функцию к каждому элементу объекта и возвращает итератор
...
# new_list = []
# for i in list_:
#     new_list.append(mul2(i))
# print(new_list)

# list_ = [1, 2, 3, 4, 5]
# mul_num = list(map(mul2, list_))
# print(mul_num)
